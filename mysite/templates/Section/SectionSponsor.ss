        ...
        <div class="section-inner">
            <div class="content typography">
				...
				<% if $Sponsors('Platinum').count %>
                    <h2 class="center sponsor-type">Platinum</h2>
				<% loop $Sponsors('Platinum') %>
                    <div class="center $EvenOdd sponsor-item platinum">
                        <h4>$Title</h4>
                        <a href="$URL" class="logo-<% if $Odd %>left<% else %>right<% end_if %>" Title="$Title" target="_blank">
				...
				<% if $Sponsors('Gold').count %>
                    <div class="clear"></div>
                    <h2 class="center sponsor-type">Gold</h2>
				<% loop $Sponsors('Gold') %>
				...
				<% if $Sponsors('Silver').count %>
                    <div class="clear"></div>
                    <h2 class="center sponsor-type">Silver</h2>
				...
				<% if $Sponsors('Bronze').count %>
                    <div class="clear"></div>
                    <h2 class="center sponsor-type">Bronze</h2>
